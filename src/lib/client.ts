...
export function Environment(name: string): BaseURL {
    return `https://${name}-abgov-ds-react-encore-ape2.encr.app`
}
...
/**
 * Client is an API client for the abgov-ds-react-encore-ape2 Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "abgov-ds-react-encore-ape2-Generated-TS-Client (Encore/v1.54.0)";
        }
